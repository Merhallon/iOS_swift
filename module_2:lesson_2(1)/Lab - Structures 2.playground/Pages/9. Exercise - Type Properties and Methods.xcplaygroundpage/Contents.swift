...
struct User {               // Пользователь
    ...
    func logIn(user: User) {
        print("Пользователь \(user.userName) авторизирован.")
    }
}
var user = User(userName: "Marina", email: "mail@mail.ru", age: 24)
print(user.currentUser)
user.logIn(user: user)

var myus = User(userName: "User", email: "l@mail.ru", age: 22)
print(myus.currentUser)
myus.logIn(user: myus)
/*:
