 ...
 */
let storedUserName = "TheFittest1"         // запомненное системой имя пользвателя
let storedPassword = "a8H1LuK91"            // запомненный системой пароль
let enteredUserName = "thefittest11"        // введённое пользователем имя
let enteredPassword: String = "a8H1LuK91"    // введённый пользователем пароль
