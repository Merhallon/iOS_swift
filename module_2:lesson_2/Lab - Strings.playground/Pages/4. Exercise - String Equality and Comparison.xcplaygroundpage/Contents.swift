 ...
 */
let nameInCaps = "МАРИНА"
let name = "марна"
if name == nameInCaps {
    print("Две строки равны")
}
else {
    print("Две строки не равны")
}
...
let nameInCapsLow = nameInCaps.lowercased()
if nameLow == nameInCapsLow {
    print("\(nameLow) и \(nameInCapsLow) равны")
}
else {
    print("\(nameLow) и \(nameInCapsLow) не равны")
}
...
if junior.hasSuffix("мл.") {
    print("Мы нашли второе поколение")
}
